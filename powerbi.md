...
4. Select Home > Edit Queries > Data source settings > Change Source and enter your Dynamics environment details: <code><pre>https://<Your Dynamics 365 (online) service URL>/api/data/v<8.0 or 8.1 or 8.2> </code>
